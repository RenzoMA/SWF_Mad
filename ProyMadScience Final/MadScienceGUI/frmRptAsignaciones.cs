    ...
    public partial class frmRptAsignaciones : Form
    {
        ...
        private void btnGenerar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ReportDataSource Reporte = new ReportDataSource("DataSet1", asiginacionBL.ReporteAsignacion(fechaInicio, fechaFin,codigoTrabajador));

                reportViewer1.LocalReport.DataSources.Add(Reporte);

                reportViewer1.LocalReport.ReportEmbeddedResource = "MadScienceGUI.reportAsignacion.rdlc";
